...
BASE_DIR = "/scratch/gilbreth/navad01/unixcoder"
OUTPUT_DIR = BASE_DIR            
...
# ==========================================
def main():
    logger.info(f"--- Starting FINAL Training Job for UniXcoder (Logs saving to {LOG_FILE}) ---")
    ...
    # UniXcoder is a standard RoBERTa model, so we can stick to BF16 if your GPU supports it
    ...
    training_args = TrainingArguments(
        ...
        bf16=True, # Ensure your GPU supports BF16 (Ampere or newer), otherwise switch to fp16=True
